...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c308 = "procedure",
      peg$c309 = peg$literalExpectation("PROCEDURE", true),
      peg$c310 = "function",
      peg$c311 = peg$literalExpectation("FUNCTION", true),
      peg$c312 = "begin",
      peg$c313 = peg$literalExpectation("BEGIN", true),
      peg$c314 = "end",
      ...
      peg$c326 = function(t, name, m, l, r, v, s) {
      ...
      peg$c335 = "if",
      peg$c336 = peg$literalExpectation("if", true),
      peg$c337 = "then",
      peg$c338 = peg$literalExpectation("then", true),
      peg$c339 = "else",
      peg$c340 = peg$literalExpectation("else", true),
      peg$c341 = function() { return DEBUG(2); },
      peg$c342 = function(e, t, f) {
            return {
              stmt: "if",
              expr: e,
              then_stmt: t,
      ...
      peg$c345 = function(lt, op, rt, expr) {
            return {
              type    : 'join',
              ltable  : lt, 
              rtable  : rt,
      ...
      peg$c352 = "return",
      peg$c353 = peg$literalExpectation("return", true),
      peg$c354 = ":=",
                                  ...
                                  if (s16 !== peg$FAILED) {
                                    ...
                                    if (s17 !== peg$FAILED) {
                                      ...
                                      if (s18 !== peg$FAILED) {
                                        ...
                                        if (s19 !== peg$FAILED) {
                                          peg$savedPos = s0;
                                          s1 = peg$c326(s2, s4, s5, s7, s9, s13, s17);
                                          s0 = s1;
                                        } else {
                                          peg$currPos = s0;
                                          s0 = peg$FAILED;
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          s12 = peg$currPos;
                          s13 = peg$parseKW_ELSE();
                          if (s13 !== peg$FAILED) {
                            s14 = peg$parse__();
                            if (s14 !== peg$FAILED) {
                              s15 = peg$parseproc_stmt();
                              if (s15 !== peg$FAILED) {
                                s16 = peg$parse__();
                                if (s16 !== peg$FAILED) {
                                  s17 = peg$parseSEMI();
                          ...
                          if (s12 !== peg$FAILED) {
                            s13 = peg$parse__();
                            if (s13 !== peg$FAILED) {
                              s14 = peg$parseKW_ENDIF();
                              if (s14 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c342(s4, s8, s12);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
